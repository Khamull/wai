...
<table align="center" style="width:450px; height:200px; border:1px solid #333">
 ...
 <td>
	...
	<form name="form1" method="post" action="sis_insert_manager_livro_caixa.jsp" onsubmit="return verForm(this)">
	<table width="540" align="center">
     ...
     <tr>
      ...
      <td width="228" align="left"><input name="banco" type="text" size="40" maxlength="50" /></td>
      <td width="69" align="left">Valor Inicial</td>
      <td width="124" align="left"><input name="valorInicial" type="text" onKeyPress="return numero(this)" value="0,00" maxlength="10" /></td>
     </tr>
     <tr>
      <td align="left" colspan="4">Descri&ccedil;&atilde;o</td>
     </tr>
     <tr>
      <td align="left" colspan="4"><textarea name="descricao" style="width:530px; border:1px solid #000"></textarea></td>
     </tr>
     <tr>
