...
rs = st.executeQuery(cargo.cargoPorId());
%>
...
<table align="center" style="width:450px; height:200px; border:1px solid #333">
 ...
 <form name="form1" method="post" action="sis_update_manager_cargo.jsp" onsubmit="return verForm(this)">
 ...
 <%} %>
  ...
  <tr>
    ...
    <td width="261" align="left"><input name="cargoTitulo" type="text" id="cargoTitulo" size="50" maxlength="50" value="<%=rs.getString("cargoTitulo") %>" /></td>
  </tr>
  <tr>
    <td align="left" valign="top">Descri&ccedil;&atilde;o do Cargo:</td>
    <td align="left"><textarea name="cargoDescricao" style="width:270px; height:100px; border:1px solid #333"><%=rs.getString("cargoDescricao") %></textarea></td>
  </tr>
  <tr>
    <td align="left"><input type="hidden" name="cargoID" value="<%=rs.getString("cargoID")%>" /></td>
    <td align="left">&nbsp;</td>
  </tr>
  <tr>
