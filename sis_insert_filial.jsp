...
function verForm(){
	...
	alert("Informe um nome para identificar essa Unidade!");
...
<!--INICIO DO FORMULÁRIO DE CADASTRO-->
 <form name="form1" method="post" action="sis_insert_manager_filial.jsp" id="form1" onSubmit="return verForm(this)">
   <table width="985" height="440">
    ...
    <tr>
     <td height="20" colspan="2" align="center"><strong>CADATRAR FILIAL</strong></td>
    </tr>
    <%if(request.getParameter("msg") != null){ %>
     <tr>
    ...
    <!--PRIMEIRA COLUNA-->
     <td valign="top">
      ...
      <table align="center">
       ...
       <tr>
         <td colspan="3" align="left"><input name="unidade" type="text" size="70" maxlength="40" /></td>
       </tr>
       <tr>
       ...
       <tr>
        ...
        <td align="left"><input name="numero" type="text" id="numero" style="width:120px" onKeyPress="return numero(this)" size="14" maxlength="6" /></td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="bairro" id="bairro" type="text" size="45" maxlength="30" /></td>
        <td align="left">&nbsp;</td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="cidade" id="cidade" type="text" size="45" maxlength="30" /></td>
        <td align="left">
        ...
        <td valign="top">
         ...
         <table align="center">
          ...
          <tr align="left">
            <td colspan="3" align="left"><input type="text" name="complemento" id="complemento" size="70" maxlength="200" /></td>
          </tr>
          <tr align="left">
            <td width="131">Respons&aacute;vel</td>
          </tr>
          <tr align="left">
            <td colspan="3"><input type="text" name="responsavel" id="responsavel" size="70" maxlength="50" /></td>
          </tr>
          <tr align="left">
          ...
          <tr align="left">
           <td><input type="text" name="telefone" id="telefone" size="14" onKeyPress="MascaraTelefone(form1.telefone);" maxlength="14"  onBlur="ValidaTelefone(form1.telefone);" style="width:120px" /></td>
           <td><input type="text" name="fax" id="fax" size="14" maxlength="14" style="width:120px" /></td>
           <td></td
           ></tr>
           <tr align="left">
          ...
          <tr align="left">
          <td align="left"><input type="text" name="celular" id="celular" size="14" onKeyPress="MascaraTelefone(form1.celular);" maxlength="15"  onBlur="ValidaTelefone(form1.celular);" style="width:120px" />
          ...
          <tr align="left">
            <td colspan="3"><input type="text" name="email" id="email" style="text-transform:lowercase;" size="70" maxlength="100" /></td>
          </tr>
          <tr align="left">
