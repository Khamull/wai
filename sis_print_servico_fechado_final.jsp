...
<%if(rs.next()){ %>
 <table align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td width="119" align="left">N&deg; Contrato</td>
    <td width="142" align="left"><%=rs.getString("contrato") %>/<%=rs.getString("dataContrato").substring(0,4)%></td>
    <td width="81" align="left">Cliente</td>
    <td width="212" align="left"><%=rs.getString("clienteNomeFantasia") %></td>
  </tr>
  <tr>
  ...
  <tr>
   <td align="left">Pago na Aprova&ccedil;&atilde;o</td>
   <td align="left"><%=formato.format(rs.getDouble("pagoNaAprovacao")) %></td>
   <td align="left"></td>
   <td align="left"></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	totalParcial = formato.format(rs.getDouble("valor")+rs.getDouble("entradaAd"));
	//totalParcial = formato.format(rs.getDouble("valor")+rs.getDouble("desconto")+rs.getDouble("pagoNaAprovacao"));	
	...
	faltaPagar = formato.format(rs.getDouble("valor") - rs.getDouble("entrada") - rs.getDouble("pagoNaAprovacao"));
	devendo = rs.getDouble("valor") - rs.getDouble("entrada") - rs.getDouble("pagoNaAprovacao");
	valorParcela = formato.format(devendo / rs.getDouble("vezes"));
	extras = formato.format(rs.getDouble("valor") - rs.getDouble("pagoNaAprovacao"));
	%>
    ...
    <%if(rs.getString("tipo").equals("C")){%>
    <tr>
      <td align="left" colspan="2">Valor pago  assinatura do Contrato/Aprova&ccedil;&atilde;o</td>
      <td align="right" colspan="2"><%=formato.format(rs.getDouble("entradaAd")+rs.getDouble("pagoNaAprovacao")) %></td>
    </tr>
    <%}%>
    <tr>
 <td align="left" colspan="2">Servi&ccedil;os Extras</td>
 <td align="right" colspan="2"><strong><%=extras %></strong></td>
</tr>

<% if(forma.formPagID != 1){ %>
<%if(rs.getDouble("entrada") > 0){%>
<tr>
