...
<%
//Recupera valores do formulário e atribui ao objeto servicometroquadrado
servicometroquadrado.servicometroquadradoID = Integer.parseInt(request.getParameter("servicometroquadradoID"));
...
rs01 = st01.executeQuery(servicometroquadrado.servicoPorID());
...
<%
//Exclui o Serviço
st.execute(servicometroquadrado.excluirServico());
%>
...
response.sendRedirect("sis_update_servico.jsp?servicoID="+servicometroquadrado.servico.servicoID+"&orcamento="+orcamento);
%>
