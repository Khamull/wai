...
<body onload="document.form1.servicoTitulo.focus(); verTipo2();">
...
<tr>
 ...
 <table width="468" border="0" align="center" cellpadding="2" cellspacing="2"  style="border:1px solid #444444">
  <tr bgcolor="#EEEEEE">
   <td colspan="2" align="center"><strong>ALTERA&Ccedil;&Atilde;O DE SERVI&Ccedil;O</strong></td>
  </tr>
  <tr>
   <td width="154" align="left">Titulo do Servi&ccedil;o <input type="hidden" name="servicoID" value="<%=rs.getString("servicoID") %>"></td>
   <td width="298" align="left"><input name="servicoTitulo" type="text" size="50" maxlength="50" value="<%=rs.getString("servicoTitulo") %>" /></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td align="left">
   <div id="porcentInput" style="display:none"><input type="text" name="valorP" maxlength="10" value="<%=rs.getString("valorP") %>" onkeypress="return numero(this)" /></div>
   <div id="metroQuadInput" style="display:none"><input type="text" name="valorM" maxlength="10" value="<%=rs.getString("valorM").replace(".",",") %>" onkeypress="return numeroVirgula(this)" /></div>
   </td>
  </tr>
  <tr>
