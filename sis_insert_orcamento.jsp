...
function pesquisaProduto(){
	...
	if(document.form1.codigo.value == "" && document.form1.produtoID.value == ""){
		...
		//alert("por codigo");
		window.location.href = "sis_insert_orcamento.jsp?buscar=ok&codigo="+cod+"&orcamentoID="+orcID;
	}else if(document.form1.codigo.value == "" && document.form1.produtoID.value != ""){
		//alert("por nome");
		window.location.href = "sis_insert_orcamento.jsp?buscar=ok&codigo="+prod+"&orcamentoID="+orcID;
	}
