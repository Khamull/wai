...
<tr>
 ...
 <br />
  <table width="900" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
    <td colspan="8" align="center"><font size="4"><strong>CONTAS A PAGAR EM: <font color="#0033CC">- <%=data.retornaData(Integer.parseInt(mes)) %> - <%=ano %></font></strong></font></td>
   </tr>
   <%if(rs01.next()){ %>
   <%
   String faltaPagar = "0";
   ...
   %>
   <tr>
    <td colspan="8" align="center">(TOTAL &Agrave; PAGAR DO M&Ecirc;S: <%=faltaPagar %>)</td>
   </tr>
   <%} %>
   <tr>
    <td colspan="8" height="20"></td>
