...
if(rs.next()){
	...
	subTotal = formato1.format(rs.getDouble("valor")-rs.getDouble("pagoNaAprovacao"));
     ...
     <tr>
      ...
      <td valign="top" width="910">
         ...
         <tr>
          ...
          <%if(!request.getParameter("assinatura").equals("N")){%>
          Desconto
          <%}%>
          </td>
         ...
         <tr>
          <td height="40"></td>
          <%if(!request.getParameter("assinatura").equals("N")){%>
          <td align="left" valign="middle" background="images/label130.png">
          <input name="desconto" type="text" class="labelPDV" onblur="descontar(); calculaTrocoB()" onKeyPress="return numero(this)" value="0,00" />
          </td>
          <%}else{%>
          <td align="left" valign="middle"><input name="desconto" type="hidden" class="labelPDV" onblur="descontar(); calculaTrocoB()" onKeyPress="return numero(this)" value="0,00" /></td>
          <%}%>          
         ...
         <tr>
          ...
          <td>
           ...
           <%}else{%>
           <input type="hidden" name="valorVariavel" value="<%=rs.getDouble("valor") - rs.getDouble("pagoNaAprovacao")%>" />
           <%}%>
           <input type="hidden" name="complementoValor" value="<%=rs.getDouble("pagoNaAprovacao")%>" />
