...
function abreRelatorio(diaA, mesA, anoA, diaB, mesB, anoB, livro){
	window.open('rep_livro_caixa.jsp?diaA='+diaA+'&mesA='+mesA+'&anoA='+anoA+'&diaB='+diaB+'&mesB='+mesB+'&anoB='+anoB+'&livroID='+livro, 'Retiradas', 'width = 800; height = 600; scrollbars=yes')
}
...
%>
 <script type="text/javascript">
  abreRelatorio('<%=request.getParameter("diaA")%>', '<%=request.getParameter("mesA")%>', '<%=request.getParameter("anoA")%>', '<%=request.getParameter("diaB")%>', '<%=request.getParameter("mesB")%>', '<%=request.getParameter("anoB")%>', '<%=request.getParameter("livroID")%>');
 </script>
<%}%>
