...
function abreRelatorio(diaA, mesA, anoA, diaB, mesB, anoB, forma){
	window.open('rep_vendas.jsp?diaA='+diaA+'&mesA='+mesA+'&anoA='+anoA+'&diaB='+diaB+'&mesB='+mesB+'&anoB='+anoB+'&forma='+forma, 'Retiradas', 'width = 800; height = 600; scrollbars=yes')
}
...
<form name="form1" method="post">
 <table align="center" width="819">
  <tr bgcolor="#EEEEEE">
   <td height="35" colspan="9" align="center"><strong>PESQUISE TODAS AS VENDAS REALIZADAS DENTRO DE UM PER&Iacute;ODO</strong></td>
  </tr>
  <tr>
