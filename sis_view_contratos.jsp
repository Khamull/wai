...
if(request.getParameter("nome") != null){
	rs = st.executeQuery(servico.pesquisaPorClienteContratos(request.getParameter("nome")));
}else{
	rs = st.executeQuery(servico.listaServicosAprovados());
}
%>
...
<tr>
 ...
 <table width="870" align="center" cellpadding="0" cellspacing="0">
   <tr>
    <td colspan="9" align="center"><strong>CONTRATOS</strong></td>
   </tr>
   <tr>
   ...
   <tr bgcolor="#EEEEEE">
    <td width="100" align="left"><strong>N&deg; Contrato</strong></td>
    <td width="270" align="left"><strong>Cliente</strong></td>
    <td width="100" align="center"><strong>Data de Inicio</strong></td>
    <td width="100" align="center"><strong>Saldo Devedor</strong></td>
   ...
   <tr>
    <td colspan="9">
     <table id="tb1" width="870" align="center" cellpadding="0" cellspacing="0">  
      <tr>
...
String cont = rs.getString("contrato");
String ano = rs.getString("dataContrato");

String numOrcamento = cont+"/"+ano.substring(0,4);
%>
   ...
   <tr>
    ...
    <td height="30" width="100" align="center"><%=formato.format(rs.getDouble("valor")-rs.getDouble("pagoNaAprovacao")) %></td>
    <td height="30" width="60" align="center"><a href="sis_update_servico.jsp?servicoID=<%=rs.getString("servicoID")%>&orcamento=n"><img src="ico/ico_editar.png" width="20" height="20" border="0" title="Editar Serviço" /></a></td>
    ...
    <!--<a href="javascript: confirma(<%//=rs.getString("servicoID")%>)">--><img src="ico/ico_cofirmar.gif" width="20" height="20" border="0" title="Nao Visualizado!"><!--</a>-->
    <%}else{ %>
    <img src="ico/ico_joinha.png" width="20" height="20" border="0" title="Ok, Visualizado!" >
    <%} %> 
    </td>
    <td height="30" width="60" align="center">
    <%if(rs.getString("visualizar").equals("S")){%>
    <a href="sis_visualizar_site.jsp?visualizar=N&servicoID=<%=rs.getString("servicoID")%>"><img src="ico/ico_ativo.png" width="20" height="20" border="0" title="Desativar Visualizaçao do Cliente" /></a>
    <%}else{%>
    <a href="sis_visualizar_site.jsp?visualizar=S&servicoID=<%=rs.getString("servicoID")%>"><img src="ico/ico_inativo.png" width="20" height="20" border="0" title="Permitir Visualizaçao do Cliente" /></a>
    <%}%>
    </td>
    <td height="30" width="60" align="center"><a href="sis_print_cupom_servico_cliente.jsp?servicoID=<%=rs.getString("servicoID")%>"><img src="ico/ico_print.png" width="20" height="20" border="0" title="Imprimir Copia do Contrato" /></a></td>
   </tr>
   <tr>
